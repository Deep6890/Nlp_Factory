...
import {
  ...
  LayoutDashboard, History, Radio, TrendingUp,
  AlertTriangle, FileText, BarChart2, Sun, Moon,
} from 'lucide-react';
...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { name: 'Live Detection', path: '/dashboard/live',     icon: Radio },
    { name: 'Insights',       path: '/dashboard/insights', icon: TrendingUp },
    { name: 'Risk Alerts',    path: '/dashboard/alerts',   icon: AlertTriangle },
  ...
  return (
    <>
      <nav className="global-navbar">
        ...
        {/* Right Side — Theme Toggle + Reminders + Profile */}
